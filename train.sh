...
TRAIN_FLAGS="--lr 3e-4 --batch_size 64 --model_dir checkpoints --log_interval 5 --save_interval 5"

python scripts/super_res_train_lightning.py --data_dir /home/linhan/data/PPT_hr_yearly/ $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS
