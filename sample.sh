...
python scripts/super_res_sample_new.py --model_path ./logs/checkpoints/prism_128_16_topo/ema_0.9999_113400.pt --data_dir /data/share/PPT_4km_128/ --topo_file /data/share/topo_4km_128.tiff $MODEL_FLAGS $DIFFUSION_FLAGS $SAMPLE_FLAGS 
