...
SAMPLE_FLAGS="--batch_size 64 --num_samples -1 --timestep_respacing 250 --dataset prism"
python scripts/super_res_sample_new.py --model_path ./logs/checkpoints/prism_128_16_topo/ema_0.9999_113400.pt --data_dir /home/linhan/data/PPT_4km_128/ --topo_file /home/linhan/data/topo_4km_128.tiff $MODEL_FLAGS $DIFFUSION_FLAGS $SAMPLE_FLAGS 
...
SAMPLE_FLAGS="--batch_size 64 --num_samples -1 --timestep_respacing 250 --dataset prism"
python scripts/super_res_sample_new.py --model_path ./logs/checkpoints/prism_128_32_topo/ema_0.9999_113400.pt --data_dir /home/linhan/data/PPT_4km_128/ --topo_file /home/linhan/data/topo_4km_128.tiff $MODEL_FLAGS $DIFFUSION_FLAGS $SAMPLE_FLAGS 
