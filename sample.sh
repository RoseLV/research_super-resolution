...
# sample_10.0_200.0_0.5
# sample_1.5_50.0_0.9
for guidance_scale in 1 0.8 0.5 0.1 1.2 1.5 2 5 10 50 100
do
    for scale in 1 2 5 10 50 100 200
    do
        for alpha in 0.9 0.5 0.1
        do
            echo "Running with guidance_scale=${guidance_scale} scale=${scale} alpha=${alpha}"
