...
SAMPLE_FLAGS="--batch_size 64 --num_samples -1 --timestep_respacing 250 --dataset prism"
python scripts/super_res_sample_new.py --model_path logs/prism_128_16_topo/checkpoints/ema_0.9999_113400.pt --data_dir /data/share/PPT_4km_128/ --topo_file /data/share/data/topo_4km_128.tiff $MODEL_FLAGS $DIFFUSION_FLAGS $SAMPLE_FLAGS 
